...
public class BlocksManager {
	...
	public static final Block MILKCRATE = new MilkCrateBlock(FabricBlockSettings.of(Material.DECORATION).strength(0.08f));
	
	public static final Block UD_MILKCRATE = new UDMilkCrateBlock(FabricBlockSettings.of(Material.DECORATION).strength(0.08f));
